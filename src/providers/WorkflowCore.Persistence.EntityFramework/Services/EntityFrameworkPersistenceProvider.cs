...
namespace WorkflowCore.Persistence.EntityFramework.Services
{
    ...
    {
        private readonly bool _canCreateDB; // todo: fix
        private readonly bool _canMigrateDB;
        private readonly WorkflowDbContext db;

        public bool SupportsScheduledCommands => true;

        public EntityFrameworkPersistenceProvider(WorkflowDbContext db)
        {
            _canCreateDB = true;//canCreateDB;
            _canMigrateDB = false;//canMigrateDB;
            this.db = db;
        }
